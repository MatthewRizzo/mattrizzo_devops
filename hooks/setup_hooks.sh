...
function run_bootstrap() {
    local -r url="https://raw.githubusercontent.com/MatthewRizzo/mattrizzo_devops/main/bootstrap.sh"
    local -r file_name="local_bootstrap.sh"
    local -r file_path="${PWD}/${file_name}"
